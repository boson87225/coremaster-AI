...
import { Zap, Swords, Target, Feather, ArrowLeft, Bot, CheckCircle, Activity, Circle, Trophy } from './icons';
import { COMBAT_SPORTS_PLAN, BASKETBALL_PLAN, BADMINTON_PLAN, VOLLEYBALL_PLAN, TENNIS_PLAN, SWIMMING_DRYLAND_PLAN } from '../constants';
