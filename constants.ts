...
export const GOLF_PLAN: SpecializedPlan = {
  key: 'golf',
  sport: "高爾夫球",
  description: "針對高爾夫揮桿所需的旋轉爆發力 (X-Factor)、核心穩定性以及髖關節活動度進行強化，提升擊球距離與準確性。",
  primarySystems: ["ATP-PCr 系統"],
  schedule: [
    {
      day: "第一天",
      focus: "旋轉爆發力與核心",
      exercises: [
        { name: "藥球側向砸牆 (Rotational Throws)", details: "4 組 x 每側 8 次" },
        { name: "高位伐木 (Woodchoppers)", details: "3 組 x 每側 12 次" },
        { name: "俄式轉體 (負重)", details: "3 組 x 20 次" },
        { name: "棒式轉體", details: "3 組 x 10 次" },
      ],
    },
    {
      day: "第二天",
      focus: "下肢穩定與平衡",
      exercises: [
        { name: "單腿硬舉 (Single Leg RDL)", details: "4 組 x 每側 8 次" },
        { name: "側弓箭步 (Side Lunge)", details: "3 組 x 每側 10 次" },
        { name: "高腳杯深蹲", details: "4 組 x 10 次" },
        { name: "單腳站立平衡", details: "3 組 x 30 秒" },
      ],
    },
    {
      day: "第三天",
      focus: "胸椎與髖關節活動度",
      exercises: [
        { name: "世界最偉大伸展", details: "3 組 x 每側 6 次" },
        { name: "胸椎轉體 (T-Spine Rotation)", details: "3 組 x 每側 10 次" },
        { name: "90/90 髖關節伸展", details: "3 組 x 60 秒" },
        { name: "貓牛式", details: "3 組 x 10 次" },
      ],
    },
  ],
};
